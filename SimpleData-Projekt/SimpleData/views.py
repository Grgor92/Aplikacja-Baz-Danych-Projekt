...
from .forms import RegistrationForm, LoginForm, przeszukiwanie_d, dok_historyczne, kontrahenci # import z innego pliku w tym samym miejscu musi zawierać . przed nazwą
